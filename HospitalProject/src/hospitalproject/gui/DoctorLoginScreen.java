...
public class DoctorLoginScreen implements ActionListener{
    ...
    public DoctorLoginScreen(){
        ...
        ImageIcon adminIconImage = new ImageIcon("src/hospitalproject/images/doctor_emoji.png");
...
//        frame.add(adminImageLabel);
        ...
        loginLabel.setText("Doctor Sign In");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == buttonCreate){
            Main.changeActiveScreen("registerAccountDoctor");
            frame.dispose();
        }
        if (e.getSource() == buttonSubmit) {
            ...
            try {
                ...
                for(Doctor doctor : doctors){
                    ...
                    if(username.equals(doctor.getUsername()) && password.equals(PasswordEncryptDecrypt.decrypt(doctor.getPassword()))){
                        
                        authenticated = true;
                        LoggedInUser.setLoggedName(doctor.getName());
                        LoggedInUser.setLoggedId(doctor.getId());
                    }
                    
                }

                if (authenticated) {
                    Main.changeActiveScreen("doctorDashboard");
